...
echo "----------------------------------------------------"
echo "Flask app will be available at: http://127.0.0.1:5001/"
echo "Analytics Dashboard will be available at: http://localhost:5006/"
echo ""
...
python full_dashboard.py > dashboard.log 2>&1 &
DASHBOARD_PID=$!
